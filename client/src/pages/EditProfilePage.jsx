...
function EditProfilePage() {
    ...
    const handleSubmit = async (e) => {
        ...
        setSuccess('');
        try {
            await api.patch('/profile', { name, bio, profilePicture });
                ...
                <div style={styles.card}>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={styles.field}>
                            ...
                            <textarea style={styles.textarea} rows={5} placeholder="Tell us about your skills and experience..." value={bio} onChange={(e) => setBio(e.target.value)} />
                            <p style={styles.hint}>Add a detailed bio then use "Extract Skills" on your profile page to auto-generate skills.</p>
                        </div>
                        <div style={styles.field}>
                            <label style={styles.label}>Profile Picture URL</label>
                            <input style={styles.input} type="url" placeholder="https://example.com/avatar.jpg" value={profilePicture} onChange={(e) => setProfilePicture(e.target.value)} />
                        </div>
...
const styles = {
    ...
    container: { maxWidth: 700, margin: '0 auto', position: 'relative', zIndex: 1 },
    ...
    textarea: { width: '100%', background: '#1e1e1e', border: '0.5px solid #2a2a2a', borderRadius: 8, padding: '12px 14px', color: '#fff', fontSize: 14, outline: 'none', fontFamily: 'inherit' },
